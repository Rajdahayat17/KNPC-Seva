...
public class user_Exam extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Exam Notice");
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot datasnapshot) {
                ...
                for (DataSnapshot snapshort : datasnapshot.getChildren()){
                    ExamData data = snapshort.getValue(ExamData.class);
                    list.add(data);
                }
                Collections.reverse(list);
                adapter = new ExamAdapter(user_Exam.this,list);
                ebookRecyler.setLayoutManager(new LinearLayoutManager(user_Exam.this));
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(user_Exam.this,error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
