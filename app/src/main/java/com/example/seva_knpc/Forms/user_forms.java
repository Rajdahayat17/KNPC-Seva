...
public class user_forms extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("FORMS Download");
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot datasnapshot) {
               ...
               for (DataSnapshot snapshort : datasnapshot.getChildren()){
                   FormData data = snapshort.getValue(FormData.class);
                   list.add(data);
               }
                Collections.reverse(list);
               adapter = new FormAdapter(user_forms.this,list);
               ebookRecyler.setLayoutManager(new LinearLayoutManager(user_forms.this));
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(user_forms.this,error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
